...
<div className={styles.searchContainer}>
  <div className={styles.nameHolder}>
    ...
    <svg className={styles.logOut} fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  <div className={styles.searchBar}>
    ...
    <svg className={styles.searchIcon} fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
