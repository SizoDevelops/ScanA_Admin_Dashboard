...
export default function SidePanel() {
 ...
 <svg   xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-file-earmark-excel" viewBox="0 0 16 16">
  ...
  <path d="M14 14V4.5L9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2M9.5 3A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5z"/>
    ...
    <Link href={`/user/${user.school_name.toLowerCase().replace(/\s+/g, '-')}/movement-register`}>
 ...
 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-x" viewBox="0 0 16 16">
  ...
  <path d="M1 5v-.5a.5.5 0 0 1 1 0V5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0V8h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1zm0 3v-.5a.5.5 0 0 1 1 0v.5h.5a.5.5 0 0 1 0 1h-2a.5.5 0 0 1 0-1z"/>
    ...
    <div className={styles.sideIcon}>
 {/* <Image sizes='30' fill src={"/icons/excel.png"} alt="Folder Icon"/> */}
 <svg   xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-journals" viewBox="0 0 16 16">
