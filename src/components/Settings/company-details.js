            ...
            <Form>
                  ...
                  <div className={styles.details}>
                    ...
                    <div className={styles.Data}>
                      ...
                      <ErrorMessage
                        ...
                        <Field
                          type="email"
                          placeholder="schoolemail@domain.co.za"
                          name="school_email"
              ...
              <div className={styles.formHolder}>
                <div className={styles.coordinates}>
                  <p>
                    {errors.school_slogan && touched.school_slogan ? (
                      <span style={{ color: "red" }}>
                        {errors.school_slogan}
                      </span>
                    ) : (
                      "School Slogan"
                    )}
                  ...
                  <Field
                    type="text"
                    placeholder="This is the school`s slogan"
                    name="school_slogan"
                    style={
                      errors.school_slogan && touched.school_slogan
                        ? { outline: "1px solid red" }
                        : { outline: "1px solid #03a4ff" }
                    }
                  />
                  <ul className={styles.listIns}>
                    <li>
                      Enter the school slogan that represents your school.
                    </li>
                  </ul>
                </div>
                <div className={styles.coordinates}>
                  ...
                  <ErrorMessage name="school_address.city" component={"p"} />
                  <Field
                    type="text"
