const endpoints = [
    {
        ...
        details: [
            ...
            {
                endpoint: "location",
                icon: <svg fill="none" stroke="#121127" strokWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" ariaHidden="true">
            ...
            {
                endpoint: "attendance",
                icon: <svg fill="none" stroke="#121127" strokeWidth="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" ariaHidden="true">
