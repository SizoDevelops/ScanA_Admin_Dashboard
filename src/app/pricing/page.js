    ...
    <body className={styles.container}>
      ...
      <div className={styles.pricing}>
        <div className={styles.intro}>
          <h1>Pricing & Plans </h1>
          <p>
            Flexible Pricing for Every Institution, Unlimited Access to
            ScanA&apos;s Powerful Features.
          </p>
        </div>
        <div className={styles.prices}>
          <div className={styles.plan}>
            <h2>Standard Plan</h2>
            <p>
              Simplify attendance tracking and elevate organizational efficiency
              with a budget-friendly solution tailored for your
            ...
            <div className={styles.price}>
              ...
              <p>
                Yearly R35 user/month <span>30% off</span>
              </p>
            </div>

            <div className={styles.buttons}>
              <span
                onClick={() => setSBilling("yearly")}
                style={
                  SBilling === "yearly"
                    ? { background: "#03a4ff", color: "#ffffff" }
                    : { background: "transparent", color: "#111115" }
                }
              >
                {" "}
                Billed Annually
            ...
            <h2 className={styles.priceData}>
              R{SBilling === "monthly" ? monthlyPrice : yearlyPrice}{" "}
              <span>per month</span>
            </h2>
          ...
          <div className={styles.plan}>
            ...
            <h2 className={styles.priceData}>
              <span>Starts at </span>R
              {PBilling === "monthly" ? PmonthlyPrice : PyearlyPrice}{" "}
              <span>per month</span>
            </h2>
            <p className={styles.based}>
              *Priced based on number of staff members.
            </p>
            <div className={styles.submit}>
              <p>Start 2 work weeks trial</p>
            </div>
        ...
        <div className={styles.free}>
          <h2>Starter Trial</h2>
          <p>
            New to ScanA? <span>Try it for free for a full year</span>, no
            obligation, no activation fees, no credit card required.
          </p>
          <div className={styles.submit}>
            <p>Try ScanA Now!</p>
          </div>
